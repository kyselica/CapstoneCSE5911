...
function loadHeartModel() {
    ...
    // Load FBX model
    fbxLoader.load('./heart.fbx', function (object) {
...
function loadHeartTexture() {
    textureLoader.load('./corazon_atropellado.jpg', function (texture) {
...
function toggleAnimation() {
    ...
    const btn = document.querySelector('.control-btn[onclick="toggleAnimation()"]');
    if (btn) {
